...
public class GUIMainButtonPanel extends JPanel {
	...
	private void initializeScrapeButtons() {
		...
		Action scrapeIVAmalgamatedAction = new ScrapeAmalgamatedAction(guiMain,
				guiMain.getAllAmalgamationOrderingPreferences().getScraperGroupAmalgamationPreference(ScraperGroupName.IV_SCRAPER_GROUP));
